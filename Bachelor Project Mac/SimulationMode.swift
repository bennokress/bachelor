...
enum SimulationMode {
    ...
    var phases: [GAPhase] {
        let phasesWithHypermutation: [GAPhase] = [ParentSelection(), Crossover(), Mutation(), Hypermutation(), SurvivorSelection()]
        let phasesWithoutHypermutation: [GAPhase] = [ParentSelection(), Crossover(), Mutation(), SurvivorSelection()]
